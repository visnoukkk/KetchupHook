...
local Mouse = pcall(function() return cloneref(LocalPlayer:GetMouse()) end) and cloneref(LocalPlayer:GetMouse()) or nil

-- declare getgenv BEFORE any use to prevent obfuscator hoisting nil crash
local getgenv = (typeof(getgenv) == "function" and getgenv) or function()
	return shared
end
...
return Library	FontColor = Color3.fromRGB(255, 255, 255);
