...
return Librarylocal function SafeParentUI(Instance: Instance, Parent: Instance | () -> Instance)
	local success, _error = pcall(function()
		if not Parent then
			Parent = CoreGui
		end
...
local Library = {
    ...
    RiskColor = Color3.fromRGB(255, 50, 50);        -- keep red

    Black = Color3.new(0, 0, 0);
    Font = Enum.Font.GothamMedium,                  -- cleaner font
...
local Templates = {
    Window = {
        Title = "KetchupHook",            -- changed default title
        AutoShow = false,
        Position = UDim2.fromOffset(175, 50),
        Size = UDim2.fromOffset(0, 0),
        AnchorPoint = Vector2.zero,
